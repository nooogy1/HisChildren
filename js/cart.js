...
const Products = {
  ...
  // Imagination Builders Collection
...
const Collections = {
  ...
  'imagination-builders': {
    ...
    description: 'Construction sets that transform simple pieces into extraordinary creations.',
  ...
  'storybook-friends': {
    ...
    description: 'Soft companions crafted from organic materials, ready for a lifetime of love.',
  ...
  'wonder-learn': {
    id: 'wonder-learn',
    name: 'Wonder & Learn',
    description: 'Thoughtful tools that nurture curiosity and celebrate the joy of discovery.',
